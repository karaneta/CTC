		...
		if (isExecutionCtxUserInterface) 
		{
			...
			if (isCreateMode || isEditMode)
			{
				...
				if (hasEntity)
				{
					...
					{
						var retainerLookUp = nlapiLookupField('customrecord_ctc_retainer', customerRetainerRef, [ 'custrecord_ctc_rtnr_total_budget'
						...
						var updateRetainerRecord = nlapiSubmitField('customrecord_ctc_retainer', customerRetainerRef, ['custrecord_ctc_rtnr_total_committed', 'custrecord_ctc_rtnr_total_billed', 'custrecord_ctc_rtnr_total_bgt_remaining']
