...
define(['N/record', 'N/search', 'N/log', 'N/runtime'],
    ...
    function (record, search, log, runtime) {
                    ...
                    if (stat === true) {
                       ...
                       // log.debug(stLogTitle, 'newItemLineCount: ' + newItemLineCount);
                        ...
                        if (consolidatedItemCount > 0) {
                            ...
                            var clearLineStat = clearEmptyTicketId(current_rec);
        ...
        function clearEmptyTicketId(current_rec){
            var stLogTitle = 'clearEmptyTicketId';
            var clearStat = false;
            var itemLineCount = current_rec.getLineCount({
                sublistId: 'item'
            });
            ...
            try {
                ...
                for (var i = 0; i < 1; i++) {
                    ...
                    log.debug(stLogTitle, i + ' |itemrow: ' + itemId + ' |ticketId:' + ticketId);
        ...
        function consolidateItem(itemArray) {
            ...
            for (var i = 0; i < itemArray.length; i++) {
                ...
                log.debug(stLogTitle, 'itemTicketId: ' + itemTicketId);
                //log.debug(stLogTitle, 'consolidatedItems: ' + JSON.stringify(consolidatedItems));
                ...
                if(itemKey === cwAgreement || itemKey === cwBlocktime || itemKey === cwFixedFee){
                    ...
                    if (!consolidatedItems[itemTicketId]) {
                        ...
                        log.debug(stLogTitle, 'consolidatedArray ' + JSON.stringify(consolidatedItems[itemTicketId]));
                    }
                }
        ...
        function mappedIndividualLine(current_rec, itemArray, itemLineCount) {
            ...
            try {
                for (var i = itemLineCount - 1; i >= 0; i--) {
                    ...
                    stLogTitle = 'mappedIndividualLine line:' + i + ' of ' + itemLineCount;
                    ...
                    //log.debug(stLogTitle, 'item: '+ item +' |timeId: ' + timeId + " |isBillable: " + isBillable);
                    ...
                    if (!isEmpty(timeId)) {
                       ...
                       // log.debug(stLogTitle, 'NO TIME ID FOUND');
                        stat = false
                    }
           ...
           // log.debug(stLogtitle, itemLineCount + ' |itemArray: ' + JSON.stringify(itemArray));
            ...
            try {
                ...
                for (var i = 0; i < itemLineCount; i++) {
                    ...
                    log.audit(stLogtitle, i + ' |itemRow:' + JSON.stringify(itemRow));
                    ...
                    var currItem = current_rec.getCurrentSublistValue({
                        sublistId: 'item',
                        fieldId: 'item'
                    });
                    log.audit(stLogtitle, i + ' |currItem:' + currItem);
